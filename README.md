...
for the variables and creating new useful variables. The dataset
generated by this script is the [**df\_rides.csv**](data/df_rides.csv),
which I recommend to use if you want to go straight to the data
analysis.
